...
class PresentationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create presentation" do
    assert_difference('Presentation.count') do
      post presentations_url, params: { presentation: { account_id: @presentation.account_id, sample_id: @presentation.sample_id, title: @presentation.title } }
    end
  ...
  test "should update presentation" do
    patch presentation_url(@presentation), params: { presentation: { account_id: @presentation.account_id, sample_id: @presentation.sample_id, title: @presentation.title } }
