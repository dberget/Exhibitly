...
class SamplesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sample" do
    assert_difference('Sample.count') do
      post samples_url, params: { sample: { body: @sample.body, title: @sample.title, url: @sample.url } }
    end
  ...
  test "should update sample" do
    patch sample_url(@sample), params: { sample: { body: @sample.body, title: @sample.title, url: @sample.url } }
